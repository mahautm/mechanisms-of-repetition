...
# Change to the analysis scripts directory
cd /home/mmahaut/projects/parrots/cycle-attention-analysis/experiments/analysis_scripts
...
python analyze_cycle_evolution_parametric.py \
    --cycles $CYCLES \
    --layer $LAYER \
    --seq_type $SEQ_TYPE \
    --all_heads \
...
echo "📁 Results saved in: ../plots/cycle_evolution_parametric/cycles_${CYCLES}/layer_${LAYER}/"
echo "📊 Parameters: cycles=$CYCLES, layer=$LAYER, seq_type=$SEQ_TYPE"
echo "Time: $(date)"